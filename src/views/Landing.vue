    ...
    <div class="position-relative">
      ...
      <section class="section-shaped my-0">
        <div class="shape shape-style-1 shape-primary shape-skew">
          <img
            style="width: 80%"
            src="img/brand/image/Path 1361.png"
            alt="logo"
          />
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <h1 class="display-3 text-dark">
                  <span> Full-Service Positioning Platform Solutions</span>
                </h1>
                <p class="lead text-dark">
                  Location-based solutions increase quality, productivity and
                  better environment.
                </p>
                <div class="btn-wrapper">
                  <base-button
                    ...
                    style="border-radius: 30px;     background: #43D683;     border-color: #43D683;"
                  >
                    Wave Me
                  </base-button>
              ...
              <div class="col-md-6">
                <img
                  style="width: 70%; margin: 0 20%"
                  src="img/brand/image/hero-bg.png"
                  class="card-img-top"
                />
